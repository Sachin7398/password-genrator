...
root = Tk()
root.config(bg='gray20') #change the background

passwordLabel= Label(root,text='Password Genrator',font=('times new roman',20, 'bold'), bg='gray20',fg='white') 
...
genrateButton = Button(root,text='Genrator',font=Font,command=generator)
